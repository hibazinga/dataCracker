...
#define Social_M "/Users/ybren/Desktop/dataCracker/dataCracker/pre/S_13_n_nu.txt"
#define Keyword_MT "/Users/ybren/Desktop/dataCracker/dataCracker/pre/user_key_word_13_ji.txt"
#define Social_MT "/Users/ybren/Desktop/dataCracker/dataCracker/pre/S_13_nu_n.txt"
...
int main(int argc, const char * argv[])
{
    ...
    if (SPARSE){
        ...
        for (step=0;step<N;step++){
            ...
            sparse_matrix_multiply(KTr, KTc, KT, M, tmp1, Kcol, Krow, Mcol, Kline);
            ...
            sparse_matrix_multiply(STr, STc, ST, M, tmp2, Scol, Srow, Mcol,Sline);
            printf("7.6\n");
